...
extends JPanel {
    ...
    private void loadOrders(LocalDate localDate, LocalDate localDate2) {
        ...
        BigDecimal total = list.stream().map(Order::getTotalAmount).reduce(BigDecimal.ZERO, BigDecimal::add);
        this.totalLabel.setText("Sales Total: Rs. " + total.toPlainString());
    }
    ...
    private void addToSelectedOrder() {
        ...
        int choice = JOptionPane.showConfirmDialog(this, panel, "Add More Items to Order #" + orderId, JOptionPane.OK_OPTION, JOptionPane.PLAIN_MESSAGE);
